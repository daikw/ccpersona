...
func RunServer(ctx context.Context, version string) error {
	...
	srv.AddTool(
		...
		[]adapter.ToolParam{
			...
			{Name: "project_dir", Description: "Absolute path to the current working directory. Used to load voice settings (provider, speaker, speed, volume) from the project's persona config.", Type: "string", Required: true},

...
and behavioral patterns for your AI assistant.`,
		...
		Commands: append([]*cli.Command{
			...
			personaCommand(),
			runtimeCommand(),
		}, hiddenRuntimeCompatibilityCommands()...),
...
func hiddenRuntimeCompatibilityCommands() []*cli.Command {
	return []*cli.Command{
		hookCommand(true),
		voiceCommand(true),
		notifyCommand(true),
...
func configCommand() *cli.Command {
	return &cli.Command{
		Name:   "config",
		Usage:  "Edit ccpersona configuration",
		Action: handleConfig,
		Flags: []cli.Flag{
			&cli.BoolFlag{
				Name:    "global",
...
func personaCommand() *cli.Command {
	return &cli.Command{
		Name:  "persona",
...
func runtimeCommand() *cli.Command {
	return &cli.Command{
		Name:  "runtime",
		Usage: "Run agent integration, voice, MCP, and engine commands",
		Commands: []*cli.Command{
			hookCommand(false),
			voiceCommand(false),
			notifyCommand(false),
...
func hookCommand(hidden bool) *cli.Command {
	return &cli.Command{
		Name:        "hook",
...
func voiceCommand(hidden bool) *cli.Command {
	return &cli.Command{
		Name:    "voice",
...
func mcpCommand(hidden bool) *cli.Command {
	return &cli.Command{
		Name:   "mcp",
...
func notifyCommand(hidden bool) *cli.Command {
	return &cli.Command{
		Name:        "notify",
...
func engineCommand(hidden bool) *cli.Command {
	return &cli.Command{
		Name:   "engine",
